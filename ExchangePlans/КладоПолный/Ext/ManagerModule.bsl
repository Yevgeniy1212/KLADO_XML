...
Процедура ПриПолученииОписанияВариантаНастройки(ОписаниеВарианта, ИдентификаторНастройки, ПараметрыКонтекста) Экспорт
	...
	ОписаниеВарианта.ПодробнаяИнформацияПоОбмену = "ПланОбмена.КладоПолный.Форма.ПодробнаяИнформация";
...
Функция ПодробнаяИнформацияПоОбмену(ИдентификаторНастройки) Экспорт
	...
	Возврат "ПланОбмена.КладоПолный.Форма.ПодробнаяИнформация";
...
Процедура ЗарегистрироватьОбъектыПодсистемыСвойства() Экспорт
	...
	Если НЕ ОбщегоНазначения.РазделениеВключено()
		...
		Запрос = Новый Запрос();
		Запрос.Параметры.Вставить("ЭтотУзел", ПланыОбмена.КладоПолный.ЭтотУзел());
		Запрос.Текст =
		"ВЫБРАТЬ
		|	ПланОбменаРИБ.Ссылка
		|ИЗ
		|	ПланОбмена.КладоПолный КАК ПланОбменаРИБ
		|ГДЕ
