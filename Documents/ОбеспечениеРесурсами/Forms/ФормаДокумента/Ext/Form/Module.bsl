...
Процедура ЗаполнитьНаСервере()
	Документы.ОбеспечениеРесурсами.ЗаполнитьПоОстаткам(Объект);
КонецПроцедуры

&НаКлиенте
Процедура ЗаполнитьПоОстаткам(Команда)
	Если Объект.Персонал.Количество() > 0 
		ИЛИ Объект.Деньги.Количество() > 0 
		ИЛИ Объект.Материалы.Количество() > 0 
		ИЛИ Объект.Инструменты.Количество() > 0 Тогда
