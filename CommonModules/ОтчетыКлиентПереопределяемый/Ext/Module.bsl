...
Процедура ОбработкаРасшифровки(ФормаОтчета, Элемент, Расшифровка, СтандартнаяОбработка) Экспорт
	...
	Если СтрНайти(ПолноеИмяОтчета,"Отчет.РаздельныйУчет") > 0  Тогда
		КЛАДО_ОтчетРаздельныйУчетКлиент.ОбработкаРасшифровки(ФормаОтчета, Элемент, Расшифровка, СтандартнаяОбработка);		
	КонецЕсли;		
