...
Процедура ПриСозданииНаСервере(Форма, Отказ, СтандартнаяОбработка) Экспорт
	//
	//Если СтрНайти(Форма.НастройкиОтчета.ПолноеИмя,"Отчет.РаздельныйУчет") > 0  
	//	И Форма.КлючНазначенияИспользования = "Расшифровка" 
	//	И Форма.Параметры.Свойство("Отбор") Тогда
	//	Для Каждого ЭлОтбор Из  Форма.Параметры.Отбор Цикл
	//		ОтчетыВызовСервера.УстановитьЭлементПользовательскогоОтбораСКД(Форма.Отчет.КомпоновщикНастроек, ВидСравненияКомпоновкиДанных.Равно, ЭлОтбор.Ключ, ЭлОтбор.Значение);
	//	КонецЦикла;
	//КонецЕсли;	
