...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Если Параметры.Свойство("ОтображатьТолькоПлан") Тогда 
		ОтображатьТолькоПлан = Параметры.ОтображатьТолькоПлан;
	КонецЕсли;
	
	ДобавитьОтборыПоПараметрамСеанса();
	
	СуммыСНДС = Истина;
	ОбновитьОтображениеНДС();
...
Процедура ОбновитьОтображениеПланФакт()
	...
	Если ОтображатьТолькоПлан Тогда 
		...
		ЭД1 = Настройки.ПараметрыДанных.Элементы.Найти("План");
		ЭД1.Значение = Истина;
		ЭД1.Использование = Истина;
		
		ЭД2 = Настройки.ПараметрыДанных.Элементы.Найти("Факт");
		ЭД2.Значение = Ложь;
		ЭД2.Использование = Истина;
...
&НаСервере
Процедура ОбновитьОтображениеНДС()
	
	Настройки = Отчет.КомпоновщикНастроек.Настройки;
	
	Если СуммыСНДС Тогда 
		
		ЭД1 = Настройки.ПараметрыДанных.Элементы.Найти("СуммыСНДС");
		ЭД1.Значение = Истина;
		ЭД1.Использование = Истина;
		
		Элементы.НДС.Пометка = Истина;
		Элементы.БезНДС.Пометка = Ложь;
	...
	Иначе 
		...
		Элементы.НДС.Пометка = Ложь;
		Элементы.БезНДС.Пометка = Истина;
