...
Функция СведенияОВнешнейОбработке() Экспорт
	...
	ПараметрыРегистрации.Наименование = "Потребность в ресурсах"; // Наименование в справочнике внешние отчеты и обработки
	ПараметрыРегистрации.БезопасныйРежим = Истина;
	ПараметрыРегистрации.Информация = "Отчет показывает какие материалы запланированы на то или иное основное средство";
