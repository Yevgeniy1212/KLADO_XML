...
Процедура ПриСозданииНаСервере(Отказ, СтандартнаяОбработка)
	...
	Элементы.Отменена.Видимость = Объект.ВидЗадачи = Перечисления.видыЗадач.Согласование;
...
Процедура ВыполненаВыполнить(Команда)
	...
	// Автор: Хохрякова И.В.
	// Дата: 21.07.2021
	Если Объект.ВидЗадачи = ПредопределенноеЗначение("Перечисление.видыЗадач.Согласование") Тогда
		Объект.РезультатСогласования = Истина;
	КонецЕсли;
	////////////////////////////////FINISH Кибернетика/////////////////////////////////////// 
...
&НаКлиенте
Процедура ВыполненаОтменить(Команда)
	
	////////////////////////////////START Кибернетика//////////////////////////////////////// 
	// Автор: Хохрякова И.В.
	// Дата: 21.07.2021
	Объект.РезультатСогласования = Ложь;
	////////////////////////////////FINISH Кибернетика/////////////////////////////////////// 
